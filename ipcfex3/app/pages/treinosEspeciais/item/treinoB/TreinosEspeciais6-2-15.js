    ...
    <View style={styles.container}>
      ...
      <ScrollView style={{ flex: 1}}>
          ...
          >
            <View style={styles.centeredView}>
              <View style={styles.modalView}>
                <Text style={{ ...styles.modalText }}>ESCALADOR DINÂMICO{"\n"}</Text>
                <ScrollView style={{alignSelf: 'flex-start'}}>
                  ...
                  <Text>
                  {"\t"}Realizar o movimento de forma dinâmica.{"\n"}
                  </Text>
                  <Text style={styles.secondModalText}>OBSERVAÇÕES:
                  </Text>
                  <Text>
                  {"\t"}Abdome contraído e quadril mexendo o mínimo possível{"\n"}
                  </Text>
                </ScrollView>
        ...
        <View style={styles.div}>
          ...
          <Video
            source={{ uri: "https://firebasestorage.googleapis.com/v0/b/videos-ccfex.appspot.com/o/12%20Escalador%20din%C3%A2mico.mov?alt=media&token=a6ac533a-c27c-4f33-ba36-2c57b49344b9" }}
            resizeMode="contain"
            shouldPlay 
            isMuted={true}
            useNativeControls
          ...
          >
            ...
            <View style={{ height: '20%',}}>
              <View style={{ display: 'flex', flexDirection: 'row', justifyContent: 'center', gap: 10, alignItems: 'center', height: 70}}>
                <Link href={`pages/treinosEspeciais/item/treinoB/TreinosEspeciais6-2-14`} asChild>
                  <Pressable
