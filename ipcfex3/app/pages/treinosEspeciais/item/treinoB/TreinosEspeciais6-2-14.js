            ...
            <View style={styles.centeredView}>
              <View style={styles.modalView}>
                ...
                <ScrollView style={{alignSelf: 'flex-start'}}>
                  ...
                  <Text>
                  {"\t"}Elevação do quadril para cima, pés próximo do glúteo{"\n"}
                  </Text>
                  <Text style={styles.secondModalText}>OBSERVAÇÕES:
                  </Text>
                  <Text>
                  {"\t"}Abdome contraído e respirando, movimento controlado{"\n"}
                  </Text>
                </ScrollView>
          ...
          >
            ...
            <View style={{ height: '20%',}}>
              <View style={{ display: 'flex', flexDirection: 'row', justifyContent: 'center', gap: 10, alignItems: 'center', height: 70}}>
                <Link href={`pages/treinosEspeciais/item/treinoB/TreinosEspeciais6-2-13`} asChild>
                  <Pressable
                ...
                <Link href={`pages/treinosEspeciais/item/treinoB/TreinosEspeciais6-2-15`} asChild>
                  <Pressable
                    style={{ ...styles.proxButton }}
                  >
