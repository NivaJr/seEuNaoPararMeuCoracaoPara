    ...
    <View style={styles.container}>
      ...
      <ScrollView style={{ flex: 1}}>
        ...
        <View style={styles.div}>
          ...
          <Video
            source={{ uri: "https://firebasestorage.googleapis.com/v0/b/videos-ccfex.appspot.com/o/03%20Afundo.mov?alt=media&token=cd0699da-92f7-4ad0-82c6-541908fdab4f" }}
            resizeMode="contain"
            shouldPlay 
            isMuted={true}
            useNativeControls
          ...
          >
            ...
            <View style={{ height: '20%',}}>
              <View style={{ display: 'flex', flexDirection: 'row', justifyContent: 'center', gap: 10, alignItems: 'center', height: 70}}>
                <Link href={`pages/treinosEspeciais/item/treinoB/TreinosEspeciais6-2-5`} asChild>
                  <Pressable
