    ...
    <View style={styles.container}>
      ...
      <ScrollView style={{ flex: 1}}>
            ...
            <View style={styles.centeredView}>
              <View style={styles.modalView}>
                ...
                <ScrollView style={{alignSelf: 'flex-start'}}>
                  ...
                  <Text>
                  {"\t"}No solo, abraçar as pernas{"\n"}
                  </Text>
                  <Text style={styles.secondModalText}>OBSERVAÇÕES:
                  </Text>
                  <Text>
                  {"\t"}Cabeça apoiada no solo e relaxado{"\n"}
                  </Text>
                </ScrollView>
        ...
        <View style={styles.div}>
          ...
          <Video
            source={{ uri: "https://firebasestorage.googleapis.com/v0/b/videos-ccfex.appspot.com/o/01%20Abra%C3%A7ando%20as%20pernas(bravo).mov?alt=media&token=05869673-27df-4b64-9715-8c4e70e15d56" }}
            resizeMode="contain"
            shouldPlay 
            isMuted={true}
            useNativeControls
