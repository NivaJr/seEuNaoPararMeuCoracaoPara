    ...
    <View style={styles.container}>
      ...
      <ScrollView style={{ flex: 1}}>
            ...
            <View style={styles.centeredView}>
              <View style={styles.modalView}>
                ...
                <ScrollView style={{alignSelf: 'flex-start'}}>
                  ...
                  <Text>
                  {"\t"}Pequena flexão de tronco, retirando as escápulas do solo{"\n"}
                  </Text>
        ...
        <View style={styles.div}>
          ...
          <Video
            source={{ uri: "https://firebasestorage.googleapis.com/v0/b/videos-ccfex.appspot.com/o/05%20Abdominal%20supra.mov?alt=media&token=68efcb68-2dbb-4b94-99f9-9cbd5a85ee15" }}
            resizeMode="contain"
            shouldPlay 
            isMuted={true}
            useNativeControls
          ...
          >
            ...
            <View style={{ height: '20%',}}>
              <View style={{ display: 'flex', flexDirection: 'row', justifyContent: 'center', gap: 10, alignItems: 'center', height: 70}}>
                <Link href={`pages/treinosEspeciais/item/treinoB/TreinosEspeciais6-2-7`} asChild>
                  <Pressable
