    ...
    <View style={styles.container}>
      ...
      <ScrollView style={{ flex: 1}}>
          ...
          >
            <View style={styles.centeredView}>
              <View style={styles.modalView}>
                <Text style={{ ...styles.modalText }}>TRÍCEPS MERGULHO(SOFÁ[PERNA ESTICADA]){"\n"}</Text>
                <ScrollView style={{alignSelf: 'flex-start'}}>
                  ...
                  <Text>
                  {"\t"}Extensão do tríceps no sofá e pernas esticadas{"\n"}
                  </Text>
        ...
        <View style={styles.div}>
          ...
          <Video
            source={{ uri: "https://firebasestorage.googleapis.com/v0/b/videos-ccfex.appspot.com/o/08%20Triceps%20mergulho(Sof%C3%A1%5Bperna%20esticada%5D).mov?alt=media&token=948cd25e-6866-4371-be13-fecf5c1f8562" }}
            resizeMode="contain"
            shouldPlay 
            isMuted={true}
            useNativeControls
          ...
          >
            ...
            <View style={{ height: '20%',}}>
              <View style={{ display: 'flex', flexDirection: 'row', justifyContent: 'center', gap: 10, alignItems: 'center', height: 70}}>
                ...
                <Link href={`pages/treinosEspeciais/item/treinoB/TreinosEspeciais6-2-12`} asChild>
                  <Pressable
                    style={{ ...styles.proxButton }}
                  >
