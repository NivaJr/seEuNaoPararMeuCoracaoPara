    ...
    <View style={styles.container}>
      ...
      <ScrollView style={{ flex: 1}}>
            ...
            <View style={styles.centeredView}>
              <View style={styles.modalView}>
                ...
                <ScrollView style={{alignSelf: 'flex-start'}}>
                  ...
                  <Text>
                  {"\t"}Movimento completo, o quadril acompanha o tronco{"\n"}
                  </Text>
        ...
        <View style={styles.div}>
          ...
          <Video
            source={{ uri: "https://firebasestorage.googleapis.com/v0/b/videos-ccfex.appspot.com/o/02%20Flex%C3%A3o%20de%20bra%C3%A7os.mov?alt=media&token=15bc2533-0c87-4025-a3ef-19bf49c96e08" }}
            resizeMode="contain"
            shouldPlay 
            isMuted={true}
            useNativeControls
          ...
          >
            ...
            <View style={{ height: '20%',}}>
              <View style={{ display: 'flex', flexDirection: 'row', justifyContent: 'center', gap: 10, alignItems: 'center', height: 70}}>
                <Link href={`pages/treinosEspeciais/item/treinoB/TreinosEspeciais6-2-4`} asChild>
                  <Pressable
                ...
                <Link href={`pages/treinosEspeciais/item/treinoB/TreinosEspeciais6-2-6`} asChild>
                  <Pressable
                    style={{ ...styles.proxButton }}
                  >
