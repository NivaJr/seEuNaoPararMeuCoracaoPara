          ...
          >
            <View style={styles.centeredView}>
              <View style={styles.modalView}>
                <Text style={{ ...styles.modalText }}>MOBILIDADE QUADRIL E TRONCO{"\n"}</Text>
                <ScrollView style={{alignSelf: 'flex-start'}}>
                  ...
                  <Text>
                  {"\t"}Acompanhar o movimento olhando para a mão{"\n"}
                  </Text>
                  <Text style={styles.secondModalText}>OBSERVAÇÕES:
                  </Text>
                  <Text>
                  {"\t"}Movimento controlado e respirando{"\n"}
                  </Text>
                </ScrollView>
          ...
          >
            ...
            <View style={{ height: '20%',}}>
              <View style={{ display: 'flex', flexDirection: 'row', justifyContent: 'center', gap: 10, alignItems: 'center', height: 70}}>
                ...
                <Link href={`pages/treinosEspeciais/item/treinoB/TreinosEspeciais6-2-3`} asChild>
                  <Pressable
                    style={{ ...styles.proxButton }}
                  >
