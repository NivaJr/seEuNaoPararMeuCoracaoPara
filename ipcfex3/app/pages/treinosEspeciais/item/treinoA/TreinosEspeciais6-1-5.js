    ...
    <View style={styles.container}>
      ...
      <ScrollView style={{ flex: 1}}>
          ...
          >
            <View style={styles.centeredView}>
              <View style={styles.modalView}>
                <Text style={{ ...styles.modalText }}>AGACHAMENTO (SOFÁ){"\n"}</Text>
                <ScrollView style={{alignSelf: 'flex-start'}}>
                  ...
                  <Text>
                    {"\t"}Realizar o movimento de agachamento, sentando no sofá{"\n"}
                  </Text>
                  <Text style={styles.secondModalText}>
                    OBSERVAÇÕES:
                  </Text>
                  <Text>
                    {"\t"}Abdome contraído, postura ereta e respirando{"\n"}
                  </Text>
                </ScrollView>
        ...
        <View style={styles.div}>
          ...
          <Video
            source={{ uri: "https://firebasestorage.googleapis.com/v0/b/videos-ccfex.appspot.com/o/02%20Agachamento%20(sof%C3%A1).mov?alt=media&token=f2a1ae6a-ee0f-4dc0-a3fd-4748daf6c10c" }}
            resizeMode="contain"
            shouldPlay 
            isMuted={true}
            useNativeControls
          ...
          >
            ...
            <View style={{ height: '20%',}}>
              <View style={{ display: 'flex', flexDirection: 'row', justifyContent: 'center', gap: 10, alignItems: 'center', height: 70}}>
                <Link href={`pages/treinosEspeciais/item/treinoA/TreinosEspeciais6-1-4`} asChild>
                  <Pressable
                ...
                <Link href={`pages/treinosEspeciais/item/treinoA/TreinosEspeciais6-1-6`} asChild>
                  <Pressable
                    style={{ ...styles.proxButton }}
                  >
