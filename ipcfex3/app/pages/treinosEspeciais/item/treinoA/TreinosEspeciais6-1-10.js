    ...
    <View style={styles.container}>
      ...
      <ScrollView style={{ flex: 1}}>
          ...
          >
            <View style={styles.centeredView}>
              <View style={styles.modalView}>
                <Text style={{ ...styles.modalText }}>ABDOMINAL SUPRA{"\n"}</Text>
                <ScrollView style={{alignSelf: 'flex-start'}}>
                  ...
                  <Text>
                    {"\t"}Realizar uma flexão de tronco{"\n"}
                  </Text>
                  <Text style={styles.secondModalText}>
                    OBSERVAÇÕES:
                  </Text>
                  <Text>
                    {"\t"}Soltar o ar na subida e realizar os movimentos de forma controlada{"\n"}
                  </Text>
                </ScrollView>
        ...
        <View style={styles.div}>
          ...
          <Video
            source={{ uri: "https://firebasestorage.googleapis.com/v0/b/videos-ccfex.appspot.com/o/08%20Abdominal%20supra.mov?alt=media&token=fd8f550a-9b03-4813-8c00-22fb314f28ec" }}
            resizeMode="contain"
            shouldPlay 
            isMuted={true}
            useNativeControls
          ...
          >
            ...
            <View style={{ height: '20%',}}>
              <View style={{ display: 'flex', flexDirection: 'row', justifyContent: 'center', gap: 10, alignItems: 'center', height: 70}}>
                <Link href={`pages/treinosEspeciais/item/treinoA/TreinosEspeciais6-1-9`} asChild>
                  <Pressable
                ...
                <Link href={`pages/treinosEspeciais/item/treinoA/TreinosEspeciais6-1-11`} asChild>
                  <Pressable
                    style={{ ...styles.proxButton }}
                  >
