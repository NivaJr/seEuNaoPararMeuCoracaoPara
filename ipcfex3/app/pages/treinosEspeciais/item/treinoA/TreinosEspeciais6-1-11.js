    ...
    <View style={styles.container}>
      ...
      <ScrollView style={{ flex: 1}}>
            ...
            <View style={styles.centeredView}>
              <View style={styles.modalView}>
                ...
                <ScrollView style={{alignSelf: 'flex-start'}}>
                  ...
                  <Text>
                    {"\t"}Realizar a extensão do cotovelo no sofá{"\n"}
                  </Text>
                  <Text style={styles.secondModalText}>
                    OBSERVAÇÕES:
                  </Text>
                  <Text>
                    {"\t"}Abdome contraído, pernas esticadas e respirando{"\n"}
                  </Text>
                </ScrollView>
        ...
        <View style={styles.div}>
          ...
          <Video
            source={{ uri: "https://firebasestorage.googleapis.com/v0/b/videos-ccfex.appspot.com/o/09%20Tr%C3%ADceps%20mergulho.mov?alt=media&token=ddd0198c-7709-42c6-a3f7-b0840aefb6f1" }}
            resizeMode="contain"
            shouldPlay 
            isMuted={true}
            useNativeControls
