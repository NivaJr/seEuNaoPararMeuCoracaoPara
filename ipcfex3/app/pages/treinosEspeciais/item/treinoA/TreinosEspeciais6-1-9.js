    ...
    <View style={styles.container}>
      ...
      <ScrollView style={{ flex: 1}}>
          ...
          >
            <View style={styles.centeredView}>
              <View style={styles.modalView}>
                <Text style={{ ...styles.modalText }}>BURPEE{"\n"}</Text>
                <ScrollView style={{alignSelf: 'flex-start'}}>
                  ...
                  <Text>
                    {"\t"}Realizar o movimento de forma dinâmica, sem pausas e usando o sofá{"\n"}
                  </Text>
                  <Text style={styles.secondModalText}>
                    OBSERVAÇÕES:
                  </Text>
        ...
        <View style={styles.div}>
          ...
          <Video
            source={{ uri: "https://firebasestorage.googleapis.com/v0/b/videos-ccfex.appspot.com/o/07%20Burppe%20(Sof%C3%A1).mov?alt=media&token=c15af363-da8b-46cc-8a18-5b7c67e56822" }}
            resizeMode="contain"
            shouldPlay 
            isMuted={true}
            useNativeControls
          ...
          >
            ...
            <View style={{ height: '20%',}}>
              <View style={{ display: 'flex', flexDirection: 'row', justifyContent: 'center', gap: 10, alignItems: 'center', height: 70}}>
                <Link href={`pages/treinosEspeciais/item/treinoA/TreinosEspeciais6-1-8`} asChild>
                  <Pressable
                ...
                <Link href={`pages/treinosEspeciais/item/treinoA/TreinosEspeciais6-1-10`} asChild>
                  <Pressable
                    style={{ ...styles.proxButton }}
                  >
