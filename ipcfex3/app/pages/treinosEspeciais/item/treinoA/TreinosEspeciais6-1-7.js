    ...
    <View style={styles.container}>
      ...
      <ScrollView style={{ flex: 1}}>
          ...
          >
            <View style={styles.centeredView}>
              <View style={styles.modalView}>
                <Text style={{ ...styles.modalText }}>CORRIDA ESTACIONÁRIA{"\n"}</Text>
        ...
        <View style={styles.div}>
          ...
          <Video
            source={{ uri: "https://firebasestorage.googleapis.com/v0/b/videos-ccfex.appspot.com/o/05%20Corrida%20estacion%C3%A1ria.mov?alt=media&token=e825cafe-9e7f-4565-809c-b8a543415b07" }}
            resizeMode="contain"
            shouldPlay 
            isMuted={true}
            useNativeControls
