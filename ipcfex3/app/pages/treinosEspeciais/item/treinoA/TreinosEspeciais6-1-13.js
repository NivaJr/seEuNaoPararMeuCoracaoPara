    ...
    <View style={styles.container}>
      ...
      <ScrollView style={{ flex: 1}}>
          ...
          >
            <View style={styles.centeredView}>
              <View style={styles.modalView}>
                <Text style={{ ...styles.modalText }}>AGACHAMENTO ISOMÉTRICO{"\n"}</Text>
                <ScrollView style={{alignSelf: 'flex-start'}}>
                  ...
                  <Text>
                    {"\t"}Realizar o agachamento apoiado na parede{"\n"}
                  </Text>
                  <Text style={styles.secondModalText}>
                    OBSERVAÇÕES:
                  </Text>
                  <Text>
                    {"\t"}Abdome contraído e joelhos a 90º{"\n"}
                  </Text>
                </ScrollView>
        ...
        <View style={styles.div}>
          ...
          <Video
            source={{ uri: "https://firebasestorage.googleapis.com/v0/b/videos-ccfex.appspot.com/o/11%20Agachamento%20Isom%C3%A9trico%20(Parede%5BFrente%5D).mov?alt=media&token=7b91bc7a-d596-4bbf-85ec-4b3f203cb82d" }}
            resizeMode="contain"
            shouldPlay 
            isMuted={true}
            useNativeControls
          ...
          >
            ...
            <View style={{ height: '20%',}}>
              <View style={{ display: 'flex', flexDirection: 'row', justifyContent: 'center', gap: 10, alignItems: 'center', height: 70}}>
                <Link href={`pages/treinosEspeciais/item/treinoA/TreinosEspeciais6-1-12`} asChild>
                  <Pressable
                ...
                <Link href={`pages/treinosEspeciais/item/treinoA/TreinosEspeciais6-1-14`} asChild>
                  <Pressable
                    style={{ ...styles.proxButton }}
                  >
