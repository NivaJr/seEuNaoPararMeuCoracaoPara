    ...
    <View style={styles.container}>
      ...
      <ScrollView style={{ flex: 1}}>
        ...
        <View style={styles.div}>
          ...
          <Video
            source={{ uri: "https://firebasestorage.googleapis.com/v0/b/videos-ccfex.appspot.com/o/12%20Escalador%20(Sof%C3%A1).mov?alt=media&token=d9da7e4b-1eb2-4820-aebe-3737e539f8e3" }}
            resizeMode="contain"
            shouldPlay 
            isMuted={true}
            useNativeControls
          ...
          >
            ...
            <View style={{ height: '20%',}}>
              <View style={{ display: 'flex', flexDirection: 'row', justifyContent: 'center', gap: 10, alignItems: 'center', height: 70}}>
                <Link href={`pages/treinosEspeciais/item/treinoA/TreinosEspeciais6-1-13`} asChild>
                  <Pressable
