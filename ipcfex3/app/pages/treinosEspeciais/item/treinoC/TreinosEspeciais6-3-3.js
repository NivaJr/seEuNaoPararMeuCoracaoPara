    ...
    <View style={styles.container}>
      ...
      <ScrollView style={{ flex: 1}}>
          ...
          >
            <View style={styles.centeredView}>
              <View style={styles.modalView}>
                <Text style={{ ...styles.modalText }}>POLICHINELOS{"\n"}</Text>
        ...
        <View style={styles.div}>
          ...
          <Video
            source={{ uri: "https://firebasestorage.googleapis.com/v0/b/videos-ccfex.appspot.com/o/03%20Polichinelos.mov?alt=media&token=5abe3fe9-1e48-4eb3-9aab-9d8d608d882e" }}
            resizeMode="contain"
            shouldPlay 
            isMuted={true}
            useNativeControls
          ...
          >
            ...
            <View style={{ height: '20%',}}>
              <View style={{ display: 'flex', flexDirection: 'row', justifyContent: 'center', gap: 10, alignItems: 'center', height: 70}}>
                <Link href={`pages/treinosEspeciais/item/treinoC/TreinosEspeciais6-3-2`} asChild>
                  <Pressable
                ...
                <Link href={`pages/treinosEspeciais/item/treinoC/TreinosEspeciais6-3-4`} asChild>
                  <Pressable
                    style={{ ...styles.proxButton }}
                  >
