          ...
          >
            ...
            <View style={{ height: '20%',}}>
              <View style={{ display: 'flex', flexDirection: 'row', justifyContent: 'center', gap: 10, alignItems: 'center', height: 70}}>
                <Link href={`pages/treinosEspeciais/item/treinoC/TreinosEspeciais6-3-3`} asChild>
                  <Pressable
                ...
                <Link href={`pages/treinosEspeciais/item/treinoC/TreinosEspeciais6-3-5`} asChild>
                  <Pressable
                    style={{ ...styles.proxButton }}
                  >
