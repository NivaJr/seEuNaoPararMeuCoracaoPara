...
import d from './Tabela-4';
import HeaderTerciario from '../../../../components/HeaderTerciario';
import Footer from '../../../../components/Footer';

export default function Tfm7_3() {
  ...
  function semana(){
    for(let i=0;i<d.length;i++){
      if(FC==d[i].semana){
        return(
          <View>
            <Text style={{color:'black', paddingTop:25, marginTop:25, textAlign:'center', fontSize:23}}>{d[i].nome}</Text>
            {
              d[i].treino.map(function(val,k){
                return(
                  <View>
  ...
  function Div2(){
    ...
    return (
        <View style={styles.container}>
          ...
          <HeaderTerciario title='5 Sessões' pai='tfm/item/Tfm-7' />
          <ScrollView style={{flex:1}}>
            <View style={styles.div}>
              <Text style={{textAlign:'center', fontWeight:'bold', borderBottomWidth:1.5, borderColor:'gray', paddingBottom:10, marginBottom:10}}>5 SESSÕES</Text>
